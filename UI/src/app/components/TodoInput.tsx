        ...
        <div className="relative flex gap-3">
          <div className="relative flex-1">
            <Input
              ...
              disabled={disabled}
              className="h-16 text-lg rounded-[20px] border-[1.5px] border-white/60 bg-white/40 backdrop-blur-2xl focus:border-[#c9b8a8]/40 focus:ring-4 focus:ring-[#c9b8a8]/10 text-[#37352f] placeholder:text-[#b5b3ad] transition-all duration-500 shadow-[0_8px_32px_-8px_rgba(197,184,168,0.1)] focus:shadow-[0_12px_48px_-8px_rgba(197,184,168,0.2)] px-6"
